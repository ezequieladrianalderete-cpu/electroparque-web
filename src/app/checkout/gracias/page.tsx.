...
export default function GraciasPage() {
  return (
    <div className="max-w-lg mx-auto px-4 py-20 text-center">
      ...
      <p className="text-gray-400 text-sm mb-8">Si no se abrió WhatsApp, contactanos al <strong>11 4412-8645</strong></p>
      <div className="flex gap-3 justify-center flex-wrap">
        ...
        <a href="https://wa.me/541144128645" target="_blank" className="border-2 border-green-500 text-green-600 font-bold px-6 py-3 rounded-xl hover:bg-green-50 transition-colors">💬 Abrir WhatsApp</a>
      </div>
    </div>
  );
}
